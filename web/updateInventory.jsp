...
input[type="text"], /* Adjusted to target text input type */
input[type="number"],
input[type="date"],
select {
...
<body>
    ...
    <form action="InventoryServlet" method="post">
        ...
        New Item Name: <input type="text" name="newItemName" required><br>
        New Quantity: <input type="number" name="newQuantity" required><br>
        New Retailer Price: <input type="number" name="newRetailerPrice" required><br>
        New Is Donation: 
        <select name="newIsDonation">
            <option value="true">Yes</option>
            <option value="false">No</option>
        </select><br>
        New Is Sale: 
        <select name="newIsSale">
            <option value="true">Yes</option>
            <option value="false">No</option>
        </select><br>
        New Discount Price: <input type="number" name="newDiscountPrice" required><br>
        New Expiration Date: <input type="date" name="newExpirationDate" required><br>
